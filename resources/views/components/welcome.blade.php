...
@endif
    ...
    <div x-data="{ open: false, selected: '' }" class="relative">
        ...
        <div x-show="open" x-on:click.away="open = false" class="absolute z-50 w-full mt-2 bg-white rounded-md shadow-lg">
          <ul class="max-h-60 rounded-md py-1 text-base leading-6 shadow-xs overflow-auto text-black focus:outline-none sm:text-sm sm:leading-5">
            <li x-on:click="selected = 'Bullying'; open = false;" class="cursor-pointer select-none relative py-2 pl-3 pr-9 hover:bg-gray-100 text-black">
              <span x-text="selected !== '' ? selected : 'Select an option'" class="block truncate text-black"></span>
              Grade 7
            </li>
            <li x-on:click="selected = 'Grade 8'; open = false;" class="cursor-pointer select-none relative py-2 pl-3 pr-9 hover:bg-gray-100 text-black">
              Grade 8
            </li>
            <li x-on:click="selected = 'Grade 9'; open = false;" class="cursor-pointer select-none relative py-2 pl-3 pr-9 hover:bg-gray-100 text-black">
              <span x-text="selected === 'Grade 9' ? '✓' : ''" class="absolute inset-y-0 left-0 flex items-center pl-3 text-blue-600"></span>
              Grade 9
            </li>
          </ul>
        </div>
                                    ...
                                    <div class="w-full lg:w-4/12 px-2">
                                        <div class="relative w-full mb-3">
                                            ...
                                            <div class="flex">
                                                ...
                                                <div class="ml-2 text-sm">
                                                    <label for="helper-checkbox" class="font-medium text-gray-900 ">
                                                    Administer appropriate classroombased
                                                    </label>

...
<div class="my-2 flex sm:flex-row flex-col py-2 px-6">
    ...
    <div class="px-6 md:px-10 py-4 md:py-2">
        <div class="flex items-center justify-between">
            <p tabindex="0" class="focus:outline-none text-base sm:text-lg md:text-xl lg:text-3xl font-bold leading-normal text-gray-800 dark:text-white">Grade Levels</p>

                            ...
                            <div class="relative w-full mb-3">
                                ...
                                <ol
                                    ...
                                    <li class="flex items-center text-blue-600 dark:text-blue-500">
                                        ...
                                        Warning <span class="hidden sm:inline-flex sm:ml-2">Info</span>
                                    ...
                                    <li class="flex items-center">
                                        ...
                                        Suspension <span class="hidden sm:inline-flex sm:ml-2">Info</span>
                                        <svg aria-hidden="true" class="w-4 h-4 ml-2 sm:ml-4" fill="none"
                                            stroke="currentColor" viewBox="0 0 24 24"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <div class="relative w-full mb-3">
                                ...
                                <div class="flex">
                                    ...
                                    <div class="ml-2 text-sm">
                                        <label for="helper-checkbox" class="font-medium text-gray-900 ">Talk with the
                                            parent</label>
                                        <p id="helper-checkbox-text" class="text-xs font-normal ">Date: 09/03/2003</p>
                                    </div>
                                </div>
                            </div>
                        </div>

...
<div class="my-2 flex sm:flex-row flex-col py-2 px-6">
    ...
    <div class="px-6 md:px-10 py-4 md:py-2">
        <div class="flex items-center justify-between">
            <p tabindex="0" class="focus:outline-none text-base sm:text-lg md:text-xl lg:text-3xl font-bold leading-normal text-gray-800 dark:text-white">Studebts Case</p>
    ...
    <div class="flex flex-row mb-1 sm:mb-0 px-6">
        <div class="relative">
            <select
...
<div class="mb-8 -mt-8 ">
    <span class="h-full absolute inset-y-0 right-0 flex items-center px-14 py-12 space-x-3 ">
        <x-button class="bg-green-400 hover:bg-green-500 shadow-sm px-4 py-2">
     <i class="fa-solid fa-file-pdf"></i>
       </x-button>
       <x-button type="button" class=" hover:bg-red-500 shadow-sm px-4 py-2">
    ...
    <div class="overflow-x-auto px-6">
        <div class="min-w-screen flex items-center justify-center font-sans overflow-hidden">
            <div class="w-full lg:w-5/6 rounded-lg">
                            ...
                            <tr class="border-b border-gray-200 hover:bg-gray-100">
                                <td class="py-3 px-6 text-left whitespace-nowrap">
                                    <div class="flex items-center">
                                        ...
                                        <span class="font-medium">Aki</span>
                                    </div>
                                </td>

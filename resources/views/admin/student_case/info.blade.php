                                ...
                                <div class="flex">
                                    <div class="flex items-center mr-4">
                                        ...
                                        <label for="inline-radio"
                                            class="ml-2 text-sm font-medium text-black">Yes</label>
                                    </div>
                                    <div class="flex items-center mr-4">
                                        <input id="inline-2-radio" type="radio" value="" name="inline-radio-group"
                                            class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                        <label for="inline-2-radio"
                                            class="ml-2 text-sm font-medium text-black">No</label>
                                    </div>
                                </div>
                                ...
                                <div class="flex">
                                    ...
                                    <div class="ml-2 text-sm">
                                        <label for="helper-checkbox"
                                            class="font-medium text-gray-900 ">Separeted</label>
                        ...
                        <div class="w-full lg:w-4/12 px-4">
                            <div class="relative w-full mb-3">
                                ...
                                <div class="flex">
                                    ...
                                    <div class="ml-2 text-sm">
                                        <label for="helper-checkbox" class="font-medium text-gray-900 ">Legally
                                            Separated</label>
                        ...
                        <div class="w-full lg:w-4/12 px-4">
                            <div class="relative w-full mb-3">
                                ...
                                <div class="flex">
                                    ...
                                    <div class="ml-2 text-sm">
                                        <label for="helper-checkbox" class="font-medium text-gray-900 ">With another
                                            partner</label>
                        ...
                        <div class="w-full lg:w-4/12 px-4">
                            <div class="relative w-full mb-3">
                                ...
                                <div class="flex">
                                    ...
                                    <div class="ml-2 text-sm">
                                        <label for="helper-checkbox" class="font-medium text-gray-900 ">Father is
                                            OFW</label>
                        ...
                        <div class="w-full lg:w-4/12 px-4">
                            <div class="relative w-full mb-3">
                                ...
                                <div class="flex">
                                    ...
                                    <div class="ml-2 text-sm">
                                        <label for="helper-checkbox" class="font-medium text-gray-900 ">Mother is
                                            OFW</label>
                ...
                <div class="flex flex-wrap">
                    ...
                    <div class="w-full lg:w-4/12 px-4">
                        <div class="flex">
                            ...
                            <div class="ml-2 text-sm">
                                <label for="helper-checkbox" class="font-medium text-gray-900 ">Work as a skilled
                                    worker</label>
                    ...
                    <div class="w-full lg:w-4/12 px-4">
                        <div class="flex">
                            ...
                            <div class="ml-2 text-sm">
                                <label for="helper-checkbox" class="font-medium text-gray-900 ">Pursue TESDA
                                    certificates</label>
                    ...
                    <div class="w-full lg:w-4/12 px-4">
                        <div class="flex">
                            ...
                            <div class="ml-2 text-sm">
                                <label for="helper-checkbox" class="font-medium text-gray-900 ">Engage in
                                    Business</label>
                    ...
                    <div class="w-full lg:w-4/12 px-4">
                        <div class="flex">
                            ...
                            <div class="ml-2 text-sm">
                                <label for="helper-checkbox" class="font-medium text-gray-900 ">Work to help
                                    parents</label>

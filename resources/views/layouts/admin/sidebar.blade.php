<aside
    ...
    <div class="items-center block w-auto max-h-screen  h-sidenav grow basis-full">
        <ul class="flex flex-col pl-0 mb-0">
            ...
            <li>
                <div x-data="{ isOpen: false }" class="flex flex-col justify-start items-center ">

                    <button @click="isOpen = !isOpen"
                        class="focus:outline-none focus:text-indigo-400 text-left text-white flex justify-between items-center py-5 mx-5 ">
                        ...
                        <span
                            class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft text-black text-sm ">
                    ...
                    <div x-show="isOpen" x-transition:enter="transition ease-out duration-200"
                        ...
                        @if(auth()->check() && auth()->user()->role == 1)
                        <a href="{{ url('admin/user/add') }}" class="flex justify-start items-center space-x-3
             text-black px-1 py-1  md:w-1">
                            <p class=" leading-4 text-sm">Add User</p>
                        </a>
                        @endif
